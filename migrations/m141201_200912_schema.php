...
class m141201_200912_schema extends Migration {
    ...
    public function safeUp() {
        ...
        $this->addForeignKey('fk_unknownword_searchRequest_id', \app\models\UnknownWord::tableName(), 'searchRequest_id', 'searchrequest', 'id', 'CASCADE');
        $this->addForeignKey('fk_dictionary_language1_id', \app\models\Dictionary::tableName(), 'language1_id', 'language', 'id', 'CASCADE');
        $this->addForeignKey('fk_dictionary_language2_id', \app\models\Dictionary::tableName(), 'language2_id', 'language', 'id', 'CASCADE');
        $this->addForeignKey('fk_word_language_id', \app\models\Word::tableName(), 'language_id', 'language', 'id', 'CASCADE');
        $this->addForeignKey('fk_translation_dictionary_id', \app\models\Translation::tableName(), 'dictionary_id', 'dictionary', 'id', 'CASCADE');
        $this->addForeignKey('fk_translation_word1_id', \app\models\Translation::tableName(), 'word1_id', 'word', 'id', 'CASCADE');
        $this->addForeignKey('fk_translation_word2_id', \app\models\Translation::tableName(), 'word2_id', 'word', 'id', 'CASCADE');
        $this->addForeignKey('fk_searchrequest_dictionary_id', \app\models\SearchRequest::tableName(), 'dictionary_id', 'dictionary', 'id', 'SET NULL');
        $this->addForeignKey('fk_searchrequest_useragent_id', \app\models\SearchRequest::tableName(), 'useragent_id', 'useragent', 'id', 'SET NULL');
